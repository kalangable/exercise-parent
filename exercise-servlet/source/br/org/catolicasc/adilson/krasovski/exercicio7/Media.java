package br.org.catolicasc.adilson.krasovski.exercicio7;
...
public class Media extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println(Head.getElement("Exercicio 7"));
		out.println("    <body role=\"document\">");
		out.println(Menu.getElement());

		out.println("		<div class=\"container theme-showcase\" role=\"main\"> ");
		out.println("			<div class=\"jumbotron\">");
		out.println("    			<h1>Exercicio 7</h1>");
		out.println("    			<p class=\"lead\">Faça um HTML que solicite 5 números para o usuário e redirecione para um Servlet que calcule a média destes números</p>");
		out.println("			</div>");
